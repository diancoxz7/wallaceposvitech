...
function WPOS() {
    ...
    this.initLogin = function(){
        ...
        if (getDeviceUUID() == null) {
            ...
            alert("Perangkat belum dikonfigurasi, silakan masuk sebagai administrator untuk mengonfigurasi perangkat..");
            initialsetup = true;
            online = true;
            return false;
        }
            ...
            if (result === true) {
                ...
                if (initialsetup) {
                    if (isUserAdmin()) {
                        ...
                        alert("Anda harus login sebagai administrator untuk pengaturan pertama kali");
                        showLogin();
                    }
                } else {
                    if (session_locked){
    ...
    function initDataSuccess(loginloader){
        if (loginloader){
            ...
            $("title").text("VitechPOS - Your POS in the cloud");
            WPOS.initPlugins();
            populateDeviceInfo();
