...
function WPOSReports() {
    ...
    this.calcReconcil = function () {
        var calcedtakings;
        var balance;
        var recdom100 = parseFloat($("#recdenom100").val()) * 100000;
        var recdom50 = parseFloat($("#recdenom50").val()) * 50000;
        var recdom20 = parseFloat($("#recdenom20").val()) * 20000;
        var recdom10 = parseFloat($("#recdenom10").val()) * 10000;
        var recdom5 = parseFloat($("#recdenom5").val()) * 5000;
        var recdom2 = parseFloat($("#recdenom2").val()) * 2000;
        var recdom1 = parseFloat($("#recdenom1").val()) * 1000;
        var recdom50c = $("#recdenom50c").val() * 500;
        var recdom20c = $("#recdenom20c").val() * 200;
        var recdom10c = $("#recdenom10c").val() * 100;
        var recdom5c = $("#recdenom5c").val() * 50;
    ...
    this.generateTakingsReport = function () {
        var html = reportheader("Laporan Pendapatan") + '<table style="width:100%;" class="table table-stripped"><thead><tr><th>Cara</th><th># Pembayaran</th><th>Pemasukan</th><th># Pengembalian</th><th>Pengembalian(Rp)</th><th>Saldo</th></tr></thead><tbody>';
    ...
    this.generateWhatsSellingReport = function () {
        var html = reportheader("Laporan Penjualan Item") + '<table style="width:100%;" class="table table-stripped"><thead><tr><th>Item</th><th># Terjual</th><th>Total</th></tr></thead><tbody>';
    ...
    this.generateSellerReport = function () {
        var html = reportheader("Pendapatan Penjual") + '<table style="width:100%;" class="table table-stripped"><thead><tr><th>User</th><th>Sales</th><th>Batal</th><th>Pengembalian</th><th>Saldo</th></tr></thead><tbody>';
